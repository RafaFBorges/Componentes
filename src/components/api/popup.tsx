    ...
    >
      <div style={styles.header}>
        <div style={styles.headerTitleSpan}>
          ...
          <Text textTag={TextTag.H6} color={styles[type].color} style={styles.title}>{title}</Text>
        </div>
        <StyledButton
      ...
      <Text textTag={TextTag.P} color={styles[type].color} style={styles.message}>{message}</Text>
    </div>
  </>
}
